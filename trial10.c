...
int main() {
    ...
    printf("(EASY) ;");
    setColor(3);
    printf("2 words are 3 to 4 letters long and will be placed either horizontally or vertically and no penalty for wrong answers;\n");
    setColor(7);
    printf("If u choose to go to the next grid\n");
    setColor(6);
    printf("(MEDIUM),");
    setColor(3);
    printf("it contains 3 words of 4 to 5 letters long which will either be placed diagonally or horizontally or vertically and penalty for wrong answers(-5);\n");
    setColor(7);
    printf("The next level \n");
    setColor(4);
    printf("(HARD) ");
    setColor(3);
    printf("also contains 3 words and is 6 to 9 letters long which will either be placed reversed or diagonally or horizontally or vertically and penalty for wrong answers(-10).\n\n");
    setColor(7);
    printf("-----------------------------------------------------\n");
    Sleep(5000);
